...
class DataCollatorForCVBert:
    ...
    def __call__(
        ...
        # Handle dict or lists with proper padding and conversion to tensor.
        #+++HANDE
        #texts, user_group_labels = zip(*examples)
        
        print('******* HANDE ********')
        print('type(examples[0]):', type(examples[0]))
        print('examples[0]:', examples[0])
        print('examples[1]:', examples[1])
        print('examples[2]:', examples[2])
        print('examples[3]:', examples[3])
        print('examples[4]:', examples[4])
        print('examples[5]:', examples[5])
        print('******* HANDE ********')
        #---HANDE
